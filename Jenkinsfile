        ...
        stage('PUSH THE DOCKER IMAGE INTO DOCKERHUB'){
            ...
            steps{
                ...
                script{
                    ...
                    withCredentials([string(credentialsId: 'docker_auth', variable: 'dockehub_pwd')]) {
                       sh "docker login -u lokeshsdockerhub --password ${dockehub_pwd}"
